...
public class IntList {
    ...
    /**
     * Returns the index of the first occurrence of the specified integer in this
     * list, or -1 if this list does not contain the integer.
     * 
     * @param n integer to search for
     * @return int the index of the first occurrence of the specified integer in
     *         this list, or -1 if this list does not contain the integer
     */
    ...
    /**
     * Compares the specified IntList for equality. Returns true if and only if both
     * lists have the same size and all corresponding pairs of integers in the tow
     * lists are equal.
     * 
    ...
    /**
     * Returns an array containing all of the integers in this list in proper
     * sequence.
     * 
    ...
    /**
     * Returns a string representation of this IntList. The string representation
     * consists of a list of the integers in the order they are indexed, enclosed in
     * square brackets ("[]")
     * 
